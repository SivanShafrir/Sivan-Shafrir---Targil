...
public class Menu implements AlgorithmOperation.Listener {
    ...
    private void decryption() {
        ...
        doubleAlgorithm.setKey(doubleKey1);
        doubleAlgorithm.decryptFile(file,fileDecrypt,(Integer)doubleKey1.secondKey);
    }
    ...
    private void encryption() {
        ...
        doubleAlgorithm.setKey(doubleKey);
        ...
        doubleAlgorithm.encryptFile(file,fileEncrypt, (Integer)doubleKey.firstKey);
    }
